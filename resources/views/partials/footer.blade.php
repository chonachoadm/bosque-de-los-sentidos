...
<div class=" mt-5 row justify-content-center">
    <div class="col-12 col-md-4 mt-3 text-center text-md-start">
        ...
        <ul class="p-0">
            ...
            <li><strong>E-mail:</strong> chonacholopez99@gmail.com</li>
    ...
    <div class="col-12 col-md-4 text-center text-md-end mt-3">
        ...
        <ul class="list-unstyled">
            <li><a href="{{ route('login') }}" class="card-titulo-link">Iniciar sesión</a></li>
            <li><a href="{{ route('register') }}" class="card-titulo-link">Crear cuenta</a></li>
        </ul>
    </div>
</div>
